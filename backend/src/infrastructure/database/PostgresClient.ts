...
// Hinweis: dotenv sollte idealerweise im Einstiegspunkt (Server.ts) geladen werden.
// Wir gehen davon aus, dass process.env hier bereits befüllt ist.
...
export class PostgresClient {
    ...
    private constructor() {
        ...
        console.log(`PostgresClient initialisiert. Verbinde zu ${config.host}:${config.port}/${config.database}`);
    }
     ...
     */
    public async query<T extends QueryResult>(queryTextOrConfig: string | QueryConfig, values?: any[]): Promise<T> {
