import { TournamentFactory, TeamData, GroupData, MatchData } from '../../../src/domain/factories/TournamentFactories';
...
describe('TournamentFactories', () => {
    ...
    test('shouldCreateTeamEntityWhenValidDataIsProvided', () => {
        ...
        // Act
        const team = TournamentFactory.createTeamFromData(data);
    ...
    test('shouldCreateGroupEntityWhenValidDataIsProvided', () => {
        ...
        // Act
        const group = TournamentFactory.createGroupFromData(data);
    ...
    test('shouldCreateMatchEntityWhenValidDataIsProvided', () => {
        ...
        // Act
        const match = TournamentFactory.createMatchFromData(data);
    ...
    test('shouldCreatePlaceholderMatchWhenArgumentsAreProvided', () => {
        ...
        // Act
        const match = TournamentFactory.createPlaceholderMatch(groupId, matchNumber, homePH, awayPH, startTime);
